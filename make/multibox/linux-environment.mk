...
# release target
neutrino-release-multibox:
	install -m 0755 $(SKEL_ROOT)/release/halt_multibox $(RELEASE_DIR)/etc/init.d/halt
	install -m 0755 $(SKEL_ROOT)/bin/showiframe $(RELEASE_DIR)/bin
	cp -f $(SKEL_ROOT)/release/fstab_multibox $(RELEASE_DIR)/etc/fstab
