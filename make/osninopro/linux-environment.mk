...
# release target
neutrino-release-osninopro:
	install -m 0755 $(SKEL_ROOT)/release/halt_osninopro $(RELEASE_DIR)/etc/init.d/halt
	cp -f $(SKEL_ROOT)/release/fstab_osninopro $(RELEASE_DIR)/etc/fstab
