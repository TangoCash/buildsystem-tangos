...
$(ARCHIVE)/$(BUILDIMAGE_SRC):
	$(DOWNLOAD) https://github.com/oe-alliance/oe-alliance-core/raw/5.0/meta-brands/meta-uclan/recipes-bsp/uclan-buildimage/$(BUILDIMAGE_SRC)
	
flash-image-ustym4kpro-multi-disk: $(ARCHIVE)/$(BUILDIMAGE_SRC) $(ARCHIVE)/$(FLASH_PARTITONS_SRC)
...
flash-image-ustym4kpro-multi-rootfs:
	rm -rf $(FLASH_BUILD_TMP) || true
	mkdir -p $(FLASH_BUILD_TMP)/$(BOXTYPE)
	cp $(RELEASE_DIR)/tmp/uImage $(FLASH_BUILD_TMP)/$(BOXTYPE)/uImage
	cd $(RELEASE_DIR); \
