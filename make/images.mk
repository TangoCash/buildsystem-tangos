...
HD61_BOOTARGS_SRC = $(KERNEL_TYPE)-bootargs-$(HD61_BOOTARGS_DATE).zip
HD61_PARTITONS_DATE = 20190719
HD61_PARTITONS_SRC = $(KERNEL_TYPE)-partitions-$(HD61_PARTITONS_DATE).zip
HD61_RECOVERY_DATE = 20190719
HD61_RECOVERY_SRC = $(KERNEL_TYPE)-recovery-$(HD61_RECOVERY_DATE).zip

$(ARCHIVE)/$(HD61_BOOTARGS_SRC):
	$(DOWNLOAD) http://downloads.mutant-digital.net/$(KERNEL_TYPE)/$(HD61_BOOTARGS_SRC)

$(ARCHIVE)/$(HD61_PARTITONS_SRC):
	$(DOWNLOAD) http://downloads.mutant-digital.net/$(KERNEL_TYPE)/$(HD61_PARTITONS_SRC)

$(ARCHIVE)/$(HD61_RECOVERY_SRC):
	$(DOWNLOAD) http://downloads.mutant-digital.net/$(KERNEL_TYPE)/$(HD61_RECOVERY_SRC)
