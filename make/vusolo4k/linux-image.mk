...
flash-image-vusolo4k-multi-rootfs:
	...
	cp $(RELEASE_DIR)/boot/vmlinuz-initrd-7366c0 $(FLASH_BUILD_TMP)/$(FLASH_PREFIX)/initrd_auto.bin
...
flash-image-vusolo4k-online:
	...
	cp $(RELEASE_DIR)/boot/vmlinuz-initrd-7366c0 $(FLASH_BUILD_TMP)/$(BOXTYPE)/initrd_auto.bin
