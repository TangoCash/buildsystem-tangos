...
KERNEL_PATCHES = \
		armbox/$(KERNEL_TYPE)/0001-mmc-switch-1.8V.patch \
...
# release target
neutrino-release-h9:
	install -m 0755 $(SKEL_ROOT)/release/halt_h9 $(RELEASE_DIR)/etc/init.d/halt
	cp -f $(SKEL_ROOT)/release/fstab_h9 $(RELEASE_DIR)/etc/fstab
