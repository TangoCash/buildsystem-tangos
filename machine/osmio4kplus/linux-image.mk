...
flashimage: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) flash-image-osmio4kplus-multi-disk flash-image-osmio4kplus-multi-rootfs
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
...
ofgimage: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) ITYPE=ofg flash-image-osmio4kplus-multi-rootfs
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
	@$(call draw_line,Build of $@ for $(BOXTYPE) successfully completed.,2);
	@$(call draw_line,);
...
online-image: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) ITYPE=online flash-image-osmio4kplus-online
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
	@$(call draw_line,Build of $@ for $(BOXTYPE) successfully completed.,2);
	@$(call draw_line,);
