...
flashimage: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) flash-image-e4hdultra-multi-disk flash-image-e4hdultra-multi-rootfs
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
...
ofgimage: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) ITYPE=ofg flash-image-e4hdultra-multi-rootfs
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
	@$(call draw_line,Build of $@ for $(BOXTYPE) successfully completed.,2);
	@$(call draw_line,);
...
online-image: $(D)/neutrino
	$(START_BUILD)
	$(MAKE) ITYPE=online flash-image-e4hdultra-online
	$(TUXBOX_CUSTOMIZE)
	@$(call draw_line,);
	@$(call draw_line,Build of $@ for $(BOXTYPE) successfully completed.,2);
	@$(call draw_line,);
